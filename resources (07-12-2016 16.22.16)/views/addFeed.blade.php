                    ...
                    <div class="modal-body">
                      ...
                      <textarea class="form-control" rows="5" name="feedContent" maxlength="400" id="contents">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="summarised" required>
                            </div>
                            <div class="form-group">
...
">
                        ...
                        <div class="pa" style="padding: 5%;">
                            <article>
                                ...
                                <p id="feedContent" style="font-size:0.78em;line-height:157%;word-spacing:8px"></p>
                            </article>
                        </div>
                        <div class="tag"
...
">
                        ...
                        <div class="pa" style="padding: 5%;">
                            <article>
                                ...
                                <p id="feedContent" style="font-size:0.77em;line-height:157%;word-spacing:8px"></p>
                            </article>
                        </div>
                        <div class="tag"
                             style="float: right;padding-right: 0%;position: fixed;bottom:142px;padding-left:27% ">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"
                                onclick="localStorage.removeItem('val')">Close
                        </button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    var items = '<?php
echo json_encode($feed,JSON_HEX_APOS);
?>';
    items = items
            .replace(/\\'/g, "\\'")
            .replace(/\\"/g, '\\"')
