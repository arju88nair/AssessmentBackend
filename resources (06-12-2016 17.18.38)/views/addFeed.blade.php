            ...
            <div class="panel panel-default" style="width:94%">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        ...
                        <span id="feedId"
                              style="font-size: 72%;color:grey">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $page['feedId'] ?></span>&nbsp;&nbsp;&nbsp;
                        <a style="text-align: center;font-weight: bolder;color:lightseagreen;font-size: 85%"
                ...
                <div id="<?= $page['_id'] ?>" class="panel-collapse collapse">
                    ...
                    <div class="panel-footer">
                        ...
                        <a style="margin-left: 54%;margin-top: 1%" href="#<?php echo '' . $id . '';?>"
                           ...
                           data-remark="<?= htmlspecialchars($page['feedRemark'], ENT_QUOTES | ENT_SUBSTITUTE | ENT_DISALLOWED | ENT_HTML5, 'UTF-8') ?>"
                           data-schedule="<?= $page['feedSchedule'] ?>"
                           data-idtag="<?= $page['_id'] ?>"
                           data-uId="<?= $page['feedId'] ?>" data-backdrop="static">Edit Shot
                        </a>
                        ...
                        <button style="margin-left: 89%;margin-top: -8.75%;" type="button"
                                ...
                                data-uId="<?= $page['feedId'] ?>"
                                data-tag="<?= $tag ?>"
                                data-tag2="<?= $tag2 ?>"
                                data-tag3="<?= $tag3 ?>"
                                data-feed="<?=  htmlspecialchars(json_encode($feed), ENT_QUOTES | ENT_SUBSTITUTE | ENT_DISALLOWED | ENT_HTML5, 'UTF-8') ?>"
...
?>';
    ...
    pager.items = jQuery.parseJSON(items);
</script>
