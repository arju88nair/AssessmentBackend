                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="post" action="{{ action('DashboardController@saveFeed') }}"
                                ...
                                <div class="fType">
                                    <select name="feedType" class="form-control" id="fType">
                                ...
                                <div class="loc">
                                    <select name="location" class="form-control" id="fLoc">
...
<script>
    ...
    $('#myModal2').on('show.bs.modal', function (event) {
		...
		modal.find('#fLoc').val(loc);
        modal.find('#fType').val(fType);
