...
//        $model->feedImage = $input['feedImage'];
    ...
    public static function saveEditFeed($input)
    {
        ...
        $model->summarised = $input['summarised'];
        $model->feedStatus = "Waiting for Approval";
        /*        $model->feedRemark = "Fix the ' in team's [Added at 2016-11-13] -------------------- What is the strategy change required? The reference is only to executing strategy and not about planning. Overall a confusing shot. [Added at -2016-11-10 05:03:58]-------";
         */
        $model->addedBy = $input['addedBy'];
        $model->feedRating = 0;
