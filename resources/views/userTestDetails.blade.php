...
<div>
    ...
    <div id="page-wrapper">
        ...
        <div style="float: right;width:40%; height:auto;margin-right: 2%" class="container">
            ...
            <a href="reportPdf?uId=<?=$userId?>&id=<?=$testId?>" class="btn btn-primary btn-block" role="button">Generate
                Report</a>
            <br>
...
";
   ...
   ";
        ...
        <div class="container">
            ...
            {{--<?php if ($fulltest['testType'] == "Non-Linear") { ?>--}}
            {{----}}
            {{----}}
                 {{--<?php } else { ?>--}}
                 {{----}}
            ...
            <?php if ($itema['keys'][$count]['answer'][0] != 'skipped') { ?> <p>
                Choice: <?=$arrayAns[$itema['keys'][$count]['answer'][0]]?></p> <?php } else { ?>
