...
<div class="login">
    <div class="alert alert-danger">
        <strong>Try Again!</strong> You entered wrong email or password.
    </div>

    <h1 id="mikro" style="margin-top: -40%;font-weight: bold;font-family: initial;margin-bottom: 25%">Mikrolearn</h1>
    <h1>Login</h1>
