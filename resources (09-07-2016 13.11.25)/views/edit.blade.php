    ...
    <div id="page-wrapper">
        ...
        <div class="container">
            ...
            <form class="form-horizontal" role="form"  method="post" action="{{ action('userController@saveEdit') }}" accept-charset="UTF-8">
                ...
                <div class="form-group">
                    <label for="sel1"  >Test Status:</label>
                ...
                <div class="form-group">
                    <label for="comment">Result Description:</label>
                    <textarea class="form-control" rows="5" name="resultDescription"><?=$tests['resultDescription']?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="axisType[]" placeholder="Enter Question Axis Type"
                               value="<?=$item['axisType']?>">
                    </div>
                </div>
                <br>
