...
class feeds extends Eloquent
{
    ...
    public static function getFeed($input)
    {
        ...
        if (!isset($user) || count($user) == 0) {
            ...
            if(count($cat)==0) {
                $feed = $model::all();
                $categories = 'All Categories,Product Management,Agile,Product Marketing,UX,Growth Hacking,Roadmapping,Sales Enablement,Career,Leadership,Executive Presence';
